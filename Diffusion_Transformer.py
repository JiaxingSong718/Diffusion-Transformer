...
from DiffusionTransformer_Block import DiffusionTransformerBlock
...
class DiffusionTransformer(nn.Module):
    def __init__(self,img_size,patch_size,channel,emb_size,label_num,dit_num,head):
        ...
        for _ in range(dit_num):
            self.dits.append(DiffusionTransformerBlock(emb_size,head))
...
if __name__=='__main__':
    dit=DiffusionTransformer(img_size=28,patch_size=4,channel=1,emb_size=64,label_num=10,dit_num=3,head=4)
